    ...
    getViewElement(me = true) {
        ...
        switch (this.type) {
            ...
            case 'image':
                ...
                div.querySelector('.message-photo').on('load', event => {
            ...
            case 'audio':
                ...
                let audioEl = div.document.querySelector('.audio')

                let loadEl = div.document.querySelector('.audio-load')

                let btnPlay = div.document.querySelector('.audio-play')
                
                let btnPause = div.document.querySelector('.audio-pause')
                
                let inputRange = div.document.querySelector('[type=range]')

                let audioDuration = div.querySelector('.message-audio-duration')

                audioEl.onloadeddata = event=>{

                    loadEl.hide()
                    btnPlay.show()
                }

                audioEl.onplay = event =>{
                ...
                audioEl.onended = event =>{

                 audioEl.currentTime = 0

                }

                audioEl.ontimeUpdate = event =>{
